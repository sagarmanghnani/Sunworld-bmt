	...
	<div class="container">
		<div class="contact-grid">
			<div class="contact-info">
				...
				<p class="contact-text serif">
					Whether you're a contractor, developer, or individual builder, our team is ready 
					to assist you with expert guidance and competitive quotes.
				</p>
